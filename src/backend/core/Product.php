...
class Product extends QueryBuilder
{
    ...
    {
        return array($this->sku, $this->name, $this->price, $this->productType, $this->attribute);
    }
    ...
    {
        return $this->insert(array($this->sku, $this->name, $this->price, $this->productType, $this->attribute));
    }
    ...
    {
        return !(preg_match('/[0-2]/', $this->inputs['productType']) && (strlen($this->inputs['productType']) > 0));
    }
